...
# save the load trace for a given population on a given day. The daily load traces are saved in ./data/faraday_raw. Using the file ./data/process_load.py, the data can be aggregated
...
for month_idx, total_month_days in enumerate(days_per_month):
    ...
    while month_day<total_month_days:
        ...
        if response.status_code == 200:
            ...
            with open(f"./data/faraday_raw/day_{count}.json", "w") as f:
